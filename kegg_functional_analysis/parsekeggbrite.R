...
icas1_kegg = read.csv("kegg_functional_analysis/icas1_keggmatches.csv")
...
icas2_kegg = read.csv("kegg_functional_analysis/icas2_keggmatches.csv")
...
vverm_kegg = read.csv("kegg_functional_analysis/vverm_keggmatches.csv")
...
aterricola_kegg = read.csv("kegg_functional_analysis/aterricola_keggmatches.csv")
...
dicty_kegg = read.csv("kegg_functional_analysis/dicty_keggmatches.csv")
...
write.csv(brite_df, "kegg_functional_analysis/keggbrite_5genomes.csv")

# format for transcriptome analysis - ignoring splice variants
icas1_kegg_nosplice <- read.csv("kegg_functional_analysis/icas1_kegg_nosplice.csv")
icas1_counts <- read.csv("kegg_functional_analysis/counts_icas1.csv")
icas2_kegg_nosplice <- read.csv("kegg_functional_analysis/icas2_kegg_nosplice.csv")
icas2_counts <- read.csv("kegg_functional_analysis/counts_icas2.csv")
...
write.csv(icas1_annotcounts, "kegg_functional_analysis/icas1_annotcounts.csv")                          
write.csv(icas2_annotcounts, "kegg_functional_analysis/icas2_annotcounts.csv")
# write combined annotation count file
write.csv(combined_annot, "kegg_functional_analysiscombined_rnaannot_full.csv")
