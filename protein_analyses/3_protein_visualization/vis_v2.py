...
TARGET_PROTEIN = "g19137.t2"   

AF_BASE     = "/home/jkniblo/Ameoba/AF_predicted"
INCENDI_DIR = f"{AF_BASE}/incendi_strucs"
CSV_DIR     = "../1_analyze_pdb_structures/structural_parameters_raw_data"
...
PLDDT_BANDS = [
    (0,   50,  "#B97878"),   # Very low  
    (50,  70,  "#C8AF78"),   # Low      
    (70,  90,  "#6E9BC3"),   # Confident 
    (90,  101, "#416AA0"),   # Very high 
]
...
def render_structure(pdb_path: str, safe_name: str,
    ...
    if representation == "cartoon":
        ...
        _apply_cartoon_settings(discrete=True)
