...
icas1_kegg = read.csv("genome_transcriptome_analysis/genome_kegg_functions/icas1_keggmatches.csv")
...
icas2_kegg = read.csv("genome_transcriptome_analysis/genome_kegg_functions/icas2_keggmatches.csv")
...
vverm_kegg = read.csv("genome_transcriptome_analysis/genome_kegg_functions/vverm_keggmatches.csv")
...
aterricola_kegg = read.csv("genome_transcriptome_analysis/genome_kegg_functions/aterricola_keggmatches.csv")
...
dicty_kegg = read.csv("genome_transcriptome_analysis/genome_kegg_functions/dicty_keggmatches.csv")
