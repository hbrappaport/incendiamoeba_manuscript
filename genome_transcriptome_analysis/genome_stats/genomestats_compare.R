...
genomestats = read.csv("genome_transcriptome_analysis/genome_stats/genomestats.csv")
busco = read.csv("genome_transcriptome_analysis/genome_stats/busco.csv")
orthocompare = read.csv("genome_transcriptome_analysis/genome_stats/orthogroup_comparison.csv")
